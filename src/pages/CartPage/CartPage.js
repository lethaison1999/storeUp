...
const CartPage = () => {
  ...
  if (carts.length === 0) {
    return (
      <div className="container my-5">
        <div className="empty-cart flex justify-center align-center flex-column font-sans-pro">
  ...
  const handleCheckOut = () => {
    alert('This position is under development...');
  };
  return (
        ...
        <div className="cart-ctable">
              ...
              return (
                <div className="cart-ctr py-4" key={cart?.id}>
                  ...
                  <div className="cart-ctd">
                    <div className="qty-change flex align-center">
                      <button
                        ...
                        onClick={() => dispatch(togleCartQty({ id: cart?.id, type: 'DEC' }))}
                      >
                      ...
                      <button
                        ...
                        onClick={() => dispatch(togleCartQty({ id: cart?.id, type: 'INC' }))}
                      >
                  ...
                  <div className="cart-ctd">
                    <button
                      type="button"
                      className="delete-btn text-dark text-uppercase"
          ...
          <div className="cart-cfoot flex align-start justify-between py-3 bg-white">
            ...
            <div className="cart-cfoot-r flex flex-column justify-end">
              ...
              <button
                type="button"
                className="checkout-btn text-white bg-orange fs-16 text-uppercase"
